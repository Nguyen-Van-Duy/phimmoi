...
const MovieDetails = () => {
    ...
    return (<>
        ...
        {!isLoading && <> <section className="detail-container container__conainer" 
        ...
        <span className="home-page container__conainer">Homepage: <a href={dataDetails.homepage} target="_blank" rel="noopener noreferrer"> {dataDetails.homepage}</a></span>
